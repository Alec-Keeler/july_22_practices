...
// SELECT COUNT(Toys.name) FROM Cats
// JOIN CatToys ON(Cats.id = CatToys.catId)
// JOIN Toys ON(Toys.id = CatToys.toyId)
// WHERE Cats.id = 7;
// SELECT Cats.id, Toys.id FROM Cats
// JOIN CatToys ON(Cats.id = CatToys.catId)
// JOIN Toys ON(Toys.id = CatToys.toyId)
// WHERE Cats.id = 7;